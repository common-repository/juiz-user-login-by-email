...
Tags: login, email, user, form, wp-login
Requires at least: 3.8
Tested up to: 4.5
Stable tag: 1.0.3

Allows users log in with its email address OR its username

== Description ==

**Since WordPress 4.5, that feature is included in the Core. You don't need this plugin anymore. Thank you all for support.**

Adds the possibility for users to log in with its email address OR its username.
Uses native WordPress functions.
Lightweight plugin, no options, just activate it and it works!

**Please, use the support forum to tell me bugs encountered, before rating the plugin. Be patient, it's free, remember it ;)**
...
1. Go to the **admin menu 'Plugins' -> 'Install'** and **search** for 'User login by email'
...
1. **Unzip** `juiz-user-login-by-email` folder to the `/wp-content/plugins/` directory
1. Go to your WP admin panel to "Appearance > Plugins" and activate
1. That's all for you!
...
= 1.0.3 =
* Informations: Since WordPress 4.5, that feature is included in the Core. You don't need this plugin anymore.
